...
paragraphs="In late summer 1945, guests are gathered for the wedding reception of Don Vito Corleones " + \
...
for word in wordlist:
	if word=="Don":
		wordfreq=wordfreq+1
print("Don appears "+str(wordfreq)+" times")
